...
WORKDIR /src
COPY ["AuditSeverityModule/AuditSeverityModule.csproj", "AuditSeverityModule/"]
RUN dotnet restore "AuditSeverityModule/AuditSeverityModule.csproj"
COPY . .
WORKDIR "/src/AuditSeverityModule"
